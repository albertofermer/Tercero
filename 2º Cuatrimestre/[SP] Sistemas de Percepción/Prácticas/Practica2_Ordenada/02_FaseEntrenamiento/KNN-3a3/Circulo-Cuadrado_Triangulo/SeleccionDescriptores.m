...
[espacioCcas, JespacioCcas]=funcion_selecciona_vector_ccas(new_X,new_Y,5);
...
save('DatosGenerados/espacio_ccas_cuadrado_triang','espacioCcas','nombresProblemaIO','X','Y');