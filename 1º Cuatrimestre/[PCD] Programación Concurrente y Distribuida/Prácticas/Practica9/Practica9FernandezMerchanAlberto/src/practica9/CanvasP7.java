...
public class CanvasP7 extends Canvas {
   ...
   private ArrayList<Image> imagenesEstudiantesEnRevPortatil;
    ...
    public CanvasP7() {
        ...
        AlumnoPracticas = getIcono("src\\practica9\\AlumnoPractica.png", 51, 84).getImage();
        AlumnoTeoria = getIcono("src\\practica9\\AlumnoTeoria.png", 70, 70).getImage();
   ...
   @Override
    ...
    public void paint(Graphics g) {
        ...
        of.fillRect(10, this.getHeight() / 2 - 250, this.getWidth() / 2 - 50, 300); // Revision con portatil
            of.drawImage(getIcono("src\\practica9\\ProfesorPortatil.png", 1280/6, 770/5).getImage(), 20, this.getHeight() / 2 - 250, this);
            of.drawImage(getIcono("src\\practica9\\ProfesorPortatil.png", 1280/6, 770/5).getImage(), 20+1280/6, this.getHeight() / 2 - 250, this);
        of.fillRect(this.getWidth() / 2, this.getHeight() / 2 - 250, this.getWidth() / 2 - 35, 300); //Revision sin portatil
            of.drawImage(getIcono("src\\practica9\\profesorSinPortatil.png", 397/2, 500/2).getImage(), 20+ this.getWidth() / 2, this.getHeight() / 2 - 250, this);
        ...
        if (EstudianteEnRevSinPortatil != -1) { //Pinta en la revision sin portatil
            ...
            of.drawImage(getIcono("src\\practica7\\AlumnoTeoria.png", 250, 250).getImage(),  250 + this.getWidth() / 2, this.getHeight() / 2 - 200, this); //Siempre sera alumno de teoria
        }
