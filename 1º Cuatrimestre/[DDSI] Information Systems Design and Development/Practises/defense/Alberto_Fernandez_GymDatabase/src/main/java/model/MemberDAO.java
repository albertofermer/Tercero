...
public class MemberDAO {
    ...
    /**
     * Returns the total price of the activities in which a member is enrolled.
     *
     * @param id identification of the member.
     * @return
     */
    public int feeOfMember(String id) {
        Transaction tr = s.beginTransaction();
        int fee = 0;
        try {
            Member1 m = s.get(Member1.class, id);
            ...
            if (e.getMessage() == null) {
                vMessage.Message("error", "The member does not exist.");
            } else {
                vMessage.Message("error", "Unknown Error:  " + e.getMessage());
            }
            tr.rollback();
        }
    ...
    /**
     * Gets the number of activities in which a member is enrolled.
     *
     * @param id
     * @return
     */
    public int getNumActivities(String id) {
        return s.get(Member1.class, id).getActivitySet().size();
    }
